...
namespace QAsist.Application.Interfaces.IServices
{
    public interface IExecutionService
    {
        ...
        Task<(IEnumerable<ExecutionStepResultDto> Results, int TotalCount)> GetResultsAsync(Guid batchId, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
